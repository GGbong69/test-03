...
func _run() -> void:
	...
	# ① 글자 크기는 다섯 단뿐이다(갈무리9 10 · 20, 갈무리11 12 · 24 · 36).
	#    정규식을 안 쓴다 — GDScript 문자열의 이스케이프와 싸우느라 자가
	#    죽는 것보다, 쉼표로 끊어 읽는 편이 짧고 안 깨진다.
	#    갈무리9 는 10 배수, 갈무리11 은 12 배수에서만 도트가 격자에 떨어진다
	#    (shot_fontgrid, 2026-09-17). 예전 다섯 단 9 · 11 · 18 · 22 · 33 은 획이 3 · 4칸으로
	#    섞여 깨졌다 — 사용자가 「커지니까 조금 깨지네」 로 짚었다.
