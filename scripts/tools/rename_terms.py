...
RENAME = {
    ...
    "소비 칸": "사탕·사진 칸",
    "소비 슬롯": "사탕·사진 칸",
    "사탕 칸": "사탕·사진 칸",   # 사진도 이 칸에 든다 — HUD 가 이미 「사탕·사진」이다
    "스타트 팩": "다트통",
    "스타트팩": "다트통",
    # ── 실제로 바꾸는 말 ──
    "칩": "기본 점수",
    ...
    "설비": "사진",
    "딱지": "뱃지",
    #  ⚠ 「팩」 홑말은 뺐다(2026-09-25). 옛날엔 스타트 팩을 가리켰지만
    #  지금은 **부스터 팩의 이름**이다(작은 팩 · 큰 팩) — 그대로 두면
    #  이 자를 돌리는 순간 boosters.csv 가 「작은 다트통」이 된다.
    #  위의 「스타트 팩」·「스타트팩」 둘이 옛 뜻을 이미 잡는다.
    "전설": "레전더리",     # 2026-09-09 · 기획서 P.15 이 이미 쓰는 말로 맞춘다
    #  죽는 것은 **칸 하나**다(sector_kill). 「구역」은 이 표에만 있던
    #  셋째 말이라(「칸」과 「영역」이 이미 다른 것을 가리킨다) 걷는다.
    #  2026-09-25
    "금지 구역": "막힌 칸",
}
